        ...
        <main>
            ...
            <div class="contenido">
                <div class="modal">
                    <form action="" method="post">
                        <h3>Convi&eacute;rtete en vendedor para desbloquear esta pagina</h3>
            ...
            <form action="" method="post">
                    ...
                    <div class="categorias">
                        ...
                        <div>
                            <input type="checkbox" name="categoria" value="" id="cat1" class="categoria-check">
                            <label for="cat1">Categor&iacute;a 1</label>
                        </div>

                        <div>
                            <input type="checkbox" name="categoria" id="cat2" class="categoria-check">
                            <label for="cat2">Categor&iacute;a 2</label>
                        </div>

                        <div>
                            <input type="checkbox" name="categoria" id="cat3" class="categoria-check">
                            <label for="cat3">Categor&iacute;a 3</label>
                        </div>

                        <div>
                            <input type="checkbox" name="categoria" id="cat4" class="categoria-check">
                            <label for="cat4">Categor&iacute;a 4</label>
                        </div>

                        <div>
                            <input type="checkbox" name="categoria" id="cat5" class="categoria-check">
                            <label for="cat5">Categor&iacute;a 5</label>
                        </div>

                        <div>
                            <input type="checkbox" name="categoria" id="cat6" class="categoria-check">
                            <label for="cat6">Categor&iacute;a 5</label>
                        </div>
                    </div>
                    <input type="submit" name="publicar" value="Publicar anuncio">
                </form>
            </div>
        </main>
    </div>
